...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Tugasku</a></h1>
...
<body>
	<div id="box">
		...
		<br><div id="menubar" align="center">
    ...
    <section id="tugas 5" class="Tugas 5 section-bg">
      <div class="container">
        <div class="section-title">
          <h2>Tugas 5</h2>
          <li class="nav-item"> <a class="nav-link" href="kondisi1.php"></a></li>
          <li class="nav-item"> <a class="nav-link" href="kondisi2.php"></a></li>
        </section>
    <!-- End Tugas 5 Section -->
    ...
    <section id="tugas 6" class="Tugas 6 section-bg">
      <div class="container">
        <div class="section-title">
          <h2>Tugas 6</h2>
          <li class="nav-item"> <a class="nav-link" href="perulangan1.php"></a></li>
          <li class="nav-item"> <a class="nav-link" href="perulangan2.php"></a></li>
          <li class="nav-item"> <a class="nav-link" href="perulangan3.php"></a></li>
    ...
    <section id="tugas 7" class="Tugas 7 section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Tugas 7</h2>
          <li class="nav-item"> <a class="nav-link" href="array.php"></a></li>
          <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>ARRAY</h4>
...
?>
                                        ...
                                        <table border="0" width="100%"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="2%">:</td>
                                                    <td style="color: #b31119; font-weight:bold">Femasta
                                                        Sembiring</td>
                                                </tr>
                                                <tr>
    ...
    <div class="row mt-5 mb-5">
        <div class="col">
            <h2 class="mb-5">AKU</h2>
        <h4>Kalau sampai waktuku
            ...
            Aku mau hidup seribu tahun lagi</h4>
        </div>
        <div class="col">
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="1000">
                                <img src="assets/img/mobilku.jpg" class="d-block w-50" alt="..." />
                            </div>
                            <div class="carousel-item" data-bs-interval="1000">
                                <img src="assets/img/logo.jpg" class="d-block w-50" alt="..." />
                            </div>
                            <div class="carousel-item" data-bs-interval="1000">
                                <img src="assets/img/miegoreng.png" class="d-block w-50" alt="..." />
                            </div>
                            <div class="carousel-item" data-bs-interval="1000">
                                <img src="assets/img/fhoto me.jpeg" class="d-block w-50" alt="..." />
                        </div>
                        <div class="carousel-item" data-bs-interval="1000">
                            <img src="assets/img/favicon.png" class="d-block w-50" alt="..." />
                    </div>
                </div>
            </div>
        </div>
